<%@ Page Language="C#" MasterPageFile="~/MasterForm/EmployeeMaster.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="ApproveUser.aspx.cs" Inherits="CavalryP.SecretaryFolder.ApproveUser" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ClientContent" runat="server">
    ...
    <div style="text-align: center">
        <asp:Label ID="NoUser" runat="server" Font-Size="50px" ForeColor="Black"></asp:Label>
    </div>
