...
namespace CavalryP.SecretaryFolder
{
    ...
    public partial class AccInformation : System.Web.UI.Page
    {
        ...
        void clear()
        {
            ddkind.SelectedValue = "Regular";
            fromDD.Visible = true;
            fromtxt.Visible = false;
            fromtxt.Text = fromDD.Text;
            toDD.Visible = true;
            totxt.Text = toDD.Text;
            totxt.Visible = false;
            dateP1.Value = DateTime.Now.ToString("yyyy-MM-dd");
            checkNumtxt.Text = "";
            amounttxt.Text = "";
            enterb.Checked = false;
            bankNameL.Visible = false;
            bankNametxt.Visible = false;
            invoiceL.Visible = false;
            invoicetxt.Visible = false;
