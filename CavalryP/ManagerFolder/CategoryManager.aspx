<%@ Page Language="C#" MasterPageFile="~/MasterForm/EmployeeMaster.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="CategoryManager.aspx.cs" Inherits="CavalryP.ManagerFolder.CategoryManager" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ClientContent" runat="server">
        ...
        <div  runat="server" id="catdiv">
            ...
            <table style="text-align: left; font-size: 17px; color: #000000;" class="auto-style14">
                <tr>
                ...
                <tr>
                    ...
                    <div id="Update" runat="server" visible="false" style="text-align: center">
                        <table style="text-align: left; font-size: 17px; color: #000000;" class="auto-style8">
                <tr>
            ...
            <br />
                ...
                <div style="text-align: center">
                    ...
                    <Columns>
                        <asp:TemplateField>
                            <HeaderTemplate>
                                 <asp:Button Text="Add Category" CssClass="gvButton" Width="200px" runat="server" ID="addCat" ForeColor="Black" style="margin-left:10px;" OnClick="addCat_Click"  />
                            </HeaderTemplate>
                            ...
                            <ItemStyle BackColor="White" Height="40px" HorizontalAlign="Left" />
                        ...
                        <asp:TemplateField HeaderText="Name">
                                 ...
                                 <ItemStyle BackColor="White" Height="20px" HorizontalAlign="Left" />
                        </asp:TemplateField>
                ...
                <br />
                <div id="catInfo" runat="server" class="auto-style13" visible="false" style="color: #000000">                    
