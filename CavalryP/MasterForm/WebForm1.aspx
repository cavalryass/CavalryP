<%@ Page Title="" Language="C#" MasterPageFile="~/MasterForm/ClientMaster.Master" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="CavalryP.MasterForm.WebForm1" %>
...
<tr>
    ...
    <td colspan="6" class="auto-style2" style="text-align: left" > <input id="memotxt" runat="server" class="auto-style12" type="text" name="phone" /></td>
</tr>

      
                         <tr>
    <td class="auto-style16">
        <asp:Button ID="cPassword" runat="server" Text="Change Password" BorderStyle="None" Height="46px" OnClick="cPassword_Click" Width="186px" CssClass="changePbutton" ClientIDMode="Predictable" ForeColor="Black"  />
                             </td>
    <td colspan="6" class="auto-style2" style="text-align: left" > <div id="passwordS" visible="false" runat="server" style="color: #000000; text-align: center;">New Password:        <input id="password" runat="server" class="input1" type="text" name="password" /></div></td>
</tr>
    ...
    <td colspan="6" class="auto-style2" style="text-align: left" > </td>
                ...
                <button type="submit" runat="server" onserverclick="update_Click" style="border-width: thin; border-style: solid; border-color: #5D7B9D; color: #5D7B9D; font-weight: bold; font-size: x-large;" class="auto-style30" >Update Details</button>
