<%@ Page Language="C#" MasterPageFile="~/MasterForm/EmployeeMaster.Master" AutoEventWireup="true" CodeBehind="Loans2Form.aspx.cs" Inherits="CavalryP.LoansFolder.Loans2Form" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ClientContent" runat="server">
          ...
          <div class="regform"><h1>Report</h1></div>
            ...
            <br />
              <div style="text-align: right">
                   <asp:Button ID="Next1" runat="server" ForeColor="Black" Text="Next" Font-Size="Large" Height="37px" Width="176px" BackColor="White" OnClick="Next1_Click" />
                    </div>
           <div>Step 1 Of 5</div>
              <br />
        ...
        <div class="main" style="color: #46AFEF">
            ...
            <Columns>   
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:Button ID="change1" runat="server" CssClass="buttonAsLink" Text="change" OnClick="change_Click" />
                                <asp:Button Text="Delete" runat="server" CssClass="buttonAsLink" CommandName="Delete" ToolTip="Delete" OnClientClick="return confirm('Are you sure  you want to delete the Account?')" OnClick="Unnamed_Click" />
...
<ItemStyle HorizontalAlign="Center" BackColor="White"></ItemStyle>
                ...
                <asp:TemplateField HeaderText="Balance Updated">
                        ...
                        <asp:TemplateField HeaderText="Terms">
                            ...
                            <ItemStyle HorizontalAlign="Left" BackColor="White" Width="100px" />
                        </asp:TemplateField>
            ...
            <div style="text-align: left">
                <div>
                   ...
                   <asp:Button ID="previous" runat="server" Text="Previous" Font-Size="Large" Height="37px" Width="137px" ForeColor="Black" BackColor="White" OnClick="previous_Click"  />
                   <asp:Button ID="Next3"  runat="server" Text="Next" Font-Size="Large" Height="37px" Width="155px" BackColor="White" ForeColor="Black" OnClick="Next3_Click"  style=" float:right; margin-right:0;"/>
     ...
     <div style="text-align: center; margin:auto;">
          ...
          <asp:GridView ID="InqGV" CssClass="auto-style24" runat="server" DataKeyNames="Id" AutoGenerateColumns="False" CellPadding="4"  ForeColor="#333333" GridLines="None" Width="1070px"  >
                     <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                     <Columns>                      
                        <asp:TemplateField>
                            <ItemTemplate>                            
...
<ItemStyle HorizontalAlign="Left" BackColor="White" Width="300px"></ItemStyle>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Id" Visible="false" >
                            <ItemTemplate>
            ...
            <div>
                   ...
                   <asp:Button ID="previous2" runat="server" Text="Previous" Font-Size="Large" Height="37px" Width="142px" BackColor="White" ForeColor="Black" OnClick="previous2_Click"   />
                   <asp:Button ID="next4" runat="server" Text="Next" Font-Size="Large" Height="37px" Width="178px" BackColor="White" ForeColor="Black" OnClick="next4_Click" style=" float:right; margin-right:0;"/>
...
<br />       
            <div>
                        ...
                        <asp:Button ID="previous3" runat="server" BackColor="White" Font-Size="Large" Height="37px" OnClick="previous3_Click" Text="Previous" ForeColor="Black" Width="123px" />
                        <asp:Button ID="next5" runat="server" BackColor="White" CssClass="auto-style59" Font-Size="Large" Height="37px" OnClick="next5_Click" ForeColor="Black" Text="Next" Width="179px" style=" float:right; margin-right:0;" />
