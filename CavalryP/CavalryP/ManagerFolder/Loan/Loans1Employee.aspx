<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Loans1Employee.aspx.cs" Inherits="CavalryP.ManagerFolder.Loan2.Loans1Employee" %>
...
<div class="regform"><h1>Application</h1></div>
        <div class="main">
            ...
            <table class="auto-style37" style="color: #5D7B9D; font-weight: bold; font-size: 18px;">
                <tr>
                    <td class="auto-style49">Business Legal Name:</td>
                    <td colspan="3">
                ...
                <tr>
                    ...
                    <td colspan="3">
                    <asp:TextBox ID="explain" runat="server" CssClass="auto-style45" BackColor="Transparent" Height="46px" ReadOnly="true" Width="1012px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td colspan="4">
...
<div class="regform"><h1>Application</h1></div>
        <div class="main" style="color: #46AFEF">
            ...
            <table class="auto-style37" style="color: #5D7B9D; font-size: 18px; font-weight: bold;">
                ...
                <tr>
                    <td colspan="7">
                    <asp:TextBox ID="BusinessLegalNameE" runat="server" CssClass="editCss" BackColor="Transparent"  Height="16px" Width="1252px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td colspan="7">&nbsp;</td>
                ...
                <tr>
                    <td colspan="5">
                    <asp:TextBox ID="dbaNameE" CssClass="editCss" runat="server" BackColor="Transparent" Height="16px"  Width="439px"></asp:TextBox>
                    </td>
                    <td colspan="2">
                    <asp:TextBox ID="PrimaryContactE" CssClass="editCss" runat="server" BackColor="Transparent" Height="16px"  Width="440px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td colspan="7">&nbsp;</td>
                ...
                <tr>
                    <td colspan="4">
                    <asp:TextBox ID="taxidE" runat="server" CssClass="editCss" BackColor="Transparent" Height="16px"  Width="240px"></asp:TextBox>
                    </td>
                    <td class="auto-style38">
                    <asp:TextBox ID="sstxtE" runat="server" CssClass="editCss" BackColor="Transparent" Height="16px" Width="240px" ></asp:TextBox>
                    </td>
                    <td>
                    <asp:TextBox ID="telephoneE" CssClass="editCss" runat="server" BackColor="Transparent" Height="16px" Width="240px"></asp:TextBox>
                    </td>
                    <td>
                    <asp:TextBox ID="emailAddressE" CssClass="editCss" runat="server" BackColor="Transparent" Height="16px"  Width="240px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td colspan="7">&nbsp;</td>
                ...
                <tr>
                    <td colspan="4">
                    <asp:TextBox ID="AddressE" runat="server" CssClass="editCss" BackColor="Transparent" Height="16px" Width="240px"></asp:TextBox>
                    </td>
                    <td class="auto-style38">
                    <asp:TextBox ID="cityE" runat="server" CssClass="editCss" BackColor="Transparent" Height="16px"  Width="240px"></asp:TextBox>
                    </td>
                    <td>
                    <asp:TextBox ID="stateE" runat="server" CssClass="editCss" BackColor="Transparent" Height="16px"  Width="240px"></asp:TextBox>
                    </td>
                    <td>
                    <asp:TextBox ID="zipE" runat="server" CssClass="editCss" BackColor="Transparent" Height="16px"  Width="240px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td colspan="4"><asp:CheckBox ID="rentE" runat="server" AutoPostBack="true" OnCheckedChanged="rent_CheckedChanged" Text="Rent"  />
                ...
                <tr>
                    <td colspan="4">Mailing Address (if different):</td>
                    <td class="auto-style38">City:</td>
                    <td>State:</td>
                    <td>Zip:</td>
                </tr>
                <tr>
                    <td colspan="4">
                    <asp:TextBox ID="mailAddressE" runat="server" CssClass="editCss" BackColor="Transparent" Height="16px" Width="240px"></asp:TextBox>
                    </td>
                    <td class="auto-style38">
                    <asp:TextBox ID="mailCityE" runat="server" CssClass="editCss" BackColor="Transparent" Height="16px"  Width="240px"></asp:TextBox>
                    </td>
                    <td>
                    <asp:TextBox ID="mailStateE" runat="server" CssClass="editCss" BackColor="Transparent" Height="16px"  Width="240px"></asp:TextBox>
                    </td>
                    <td>
                    <asp:TextBox ID="mailZipE" runat="server" CssClass="editCss" BackColor="Transparent" Height="16px"  Width="240px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td colspan="7">&nbsp;</td>
                    ...
                    <td colspan="7">
                        <table class="auto-style37">
                            ...
                            <tr>
                                ...
                                <td>
                                <asp:TextBox ID="othertxtE1" CssClass="editCss" runat="server" BackColor="Transparent" Width="130px"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td>Month</td>
                    <td>
                                <asp:TextBox ID="monthE" runat="server" CssClass="editCss" BackColor="Transparent" Height="16px" Width="80px"></asp:TextBox>
                            </td>
                    <td>Year</td>
                    <td>
                                <asp:TextBox ID="yearE" runat="server" CssClass="editCss" BackColor="Transparent" Height="16px" Width="80px"></asp:TextBox>
                            </td>
                    <td class="auto-style38">
                    <asp:TextBox ID="incorporationStateE" runat="server" CssClass="editCss" BackColor="Transparent" Height="16px"  Width="240px"></asp:TextBox>
                    </td>
                    <td>
                    <asp:TextBox ID="employeesNumE" runat="server" CssClass="editCss" BackColor="Transparent"  Width="240px"></asp:TextBox>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <asp:TextBox ID="explainE" runat="server" CssClass="editCss" BackColor="Transparent" Height="46px" Width="1252px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td colspan="7">&nbsp;</td>
                    ...
                    <td colspan="7">
                        <table class="auto-style37">
                            <tr>
                                ...
                                <td>
                                <asp:TextBox ID="othertxt2E" runat="server" CssClass="editCss" BackColor="Transparent"  Width="130px"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td colspan="7">
                    <asp:TextBox ID="listCompaniesE" runat="server" CssClass="editCss" BackColor="Transparent" Height="30px" Width="1252px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td colspan="7">&nbsp;</td>
